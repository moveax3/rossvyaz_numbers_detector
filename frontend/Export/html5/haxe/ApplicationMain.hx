...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Frontend", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Frontend", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Frontend";
		app.meta["name"] = "Frontend";
		app.meta["packageName"] = "com.sample.frontend";
